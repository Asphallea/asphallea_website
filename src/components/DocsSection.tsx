...
result = sandbox.run(cmd, policy=policy, allow_degraded=True)`,
    ...
    },
    {
      ...
      title: 'BinaryVerificationFailed (SHA-256 Hash Mismatch)',
      category: 'Errors & Fixes',
      summary: 'Raised when the internal SHA-256 hash of asphallea-run does not match the PyPI signed manifest.',
      symptom: 'asphallea.exceptions.BinaryVerificationFailed: SHA-256 binary hash mismatch',
      solution: 'Reinstall the Python package cleanly with "pip install --force-reinstall asphallea" or verify ASPHALLEA_CORE_BIN env variable.',
    },
    {
