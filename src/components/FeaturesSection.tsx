...
export function FeaturesSection() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-0 border border-white/10 rounded-xl overflow-hidden glass-panel">
      ...
      <div className="p-8 flex flex-col gap-4 divider-y relative">
        <div className="w-12 h-12 rounded-lg code-window flex items-center justify-center text-primary border-primary/20">
